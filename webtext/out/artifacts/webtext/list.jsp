...
<div class="container">
    ...
    <div  style="float: left;margin:5px"  method="post">
        <form action="${pageContext.request.contextPath}/findUserByIdServlet" method="post" class="form-inline">
            <div class="form-group">
                <label for="exampleInputName2">id:</label>
                <input type="text" name="id"  class="form-control" id="exampleInputName2" >
            </div>

            <button type="submit" class="btn btn-default">查询</button>
        </form>
    </div>
    <a class="btn btn-primary" href="adds.jsp">添加联系人</a>
